...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/amaranta-ursula-xhs"
api_key=''
...
for name in ["02-europe","03-return","04-lovers","05-birth","06-ending"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
