...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/melquiades-xhs"
api_key=''
...
for name in ["02-arrival","03-death","04-room","05-ghost","06-prophecy"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
