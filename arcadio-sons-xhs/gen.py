...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/arcadio-sons-xhs"
api_key=''
...
for name in ["02-arcadio","03-aureliano-jose","04-17sons","05-massacre","06-ending"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
