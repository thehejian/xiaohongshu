...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/remedios-xhs"
api_key=''
...
for name in ["02-simple","03-men","04-laundry","05-purity","06-sky"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
