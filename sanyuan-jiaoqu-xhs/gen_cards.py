...
C="tyf-cover"
P="Ancient Catholic church complex in rural Shaanxi, Sino-Western hybrid architecture, gray brick walls, Gothic windows with Chinese roof, historical religious compound, ink-wash painting style, ultra-detailed 8K"
def gen():
    for a in range(3):
