...
C="wxj-cover"
P="Ancient Romanesque Catholic cathedral in Xi'an city, colorful stained glass, intricate brick carvings, historical urban church built 1716, ink-wash painting with Western architectural elements, ultra-detailed 8K"
def gen():
    for a in range(3):
