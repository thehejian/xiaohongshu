...
def call_agnes(prompt, ref_b64=None, retries=3):
    ...
    return None
PROMPTS = [
    "Ancient Chinese express rider on horseback galloping through mountain landscape raising dust, Tang dynasty imperial courier, dramatic motion blur, golden hour, NO text",
    "Ancient Chinese map showing route from Fuling through Dazhou to Chang'an, Tang dynasty postal relay system, topographic style, sepia tones, NO text",
    "Fresh red lychee fruit with green leaves on ancient Chinese wooden tray, Tang dynasty imperial delicacy, close-up food photography style, warm lighting, NO text",
    "Emperor Xuanzong Tang dynasty imperial palace scene, concubine Yang Guifei smiling at fresh lychee delivery, luxurious court scene, traditional Chinese painting, NO text",
    "Du Mu ancient Chinese poet writing famous poem about lychee rider raising red dust, Tang dynasty scholar, poetic mountain landscape background, NO text",
    "Tang dynasty relay station system with multiple riders changing horses rapidly, imperial express network, dramatic mountain passes, NO text",
]
if __name__ == "__main__":
    print("Generating 6 images for 荔枝道...")
