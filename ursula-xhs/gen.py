...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/ursula-xhs"
api_key=''
...
for name in ["02-young","03-candy","04-blind","05-banana","06-death"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
