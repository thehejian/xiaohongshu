...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/cape-verde-xhs"
api_key=''
...
cards=[("02-knockout","02-knockout"),("03-country","03-country"),("04-team","04-team"),("05-journey","05-journey"),("06-ending","06-ending")]
for name,fname in cards:
    ...
    with open(f"/tmp/cv_{name}.json","w") as f: json.dump(payload,f)
    r=subprocess.run(["curl","-s","--max-time","300","-H","Authorization: Bearer "+api_key,"-H","Content-Type: application/json","-d",f"@/tmp/cv_{name}.json","https://apihub.agnes-ai.com/v1/images/generations"],capture_output=True,text=True,timeout=300)
