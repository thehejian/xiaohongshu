...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/pilpet-xhs"
api_key=''
...
for name in ["02-pilar","03-petra","04-cards","05-lottery","06-legacy"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
