...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/jose-arcadio-segundo-xhs"
api_key=''
...
for name in ["02-twin","03-foreman","04-massacre","05-room","06-death"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
