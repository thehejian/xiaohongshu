...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/amaranta-rebeca-xhs"
api_key=''
...
for name in ["02-rebeca","03-amaranta","04-pietro","05-rebeca-ending","06-amaranta-ending"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
