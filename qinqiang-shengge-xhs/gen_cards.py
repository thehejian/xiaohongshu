...
C="qq-cover"
P="Traditional Shaanxi Qin Opera performance on stage, elderly musicians playing traditional instruments, vivid costumes and makeup, cultural heritage scene, ink-wash painting style, warm passionate atmosphere, ultra-detailed 8K"
def gen():
    for a in range(3):
