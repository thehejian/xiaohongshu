...
C="wqz-cover"
P="Ancient Chinese Catholic church with traditional Chinese architecture, cross on roof, nestled in village near Zhongnan Mountains, misty landscape, ink-wash painting style, peaceful rural atmosphere, ultra-detailed 8K"
def gen():
    for a in range(3):
