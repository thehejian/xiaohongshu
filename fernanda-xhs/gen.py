...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/fernanda-xhs"
api_key=''
...
for name in ["02-queen","03-wedding","04-house","05-decision","06-alone"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
