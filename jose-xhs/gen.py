...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/jose-xhs"
api_key=''
...
for name in ["02-founder","03-tree","04-run","05-marriage","06-blood"]:
    p=open(f"{BASE}/prompts/{name}.md").read().strip()
