...
C="mxsz-cover"
P="Catholic pilgrimage mountain in Qinling, Shaanxi China, a hill with cross on top, Stations of the Cross along a winding path, misty mountain landscape, traditional Chinese ink-wash painting style, serene spiritual atmosphere, ultra-detailed 8K"
def gen():
    for a in range(3):
...
def main():
    gen()
    # Cards 1-3 are real photos from web, already downloaded
