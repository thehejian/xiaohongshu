...
Create a Xiaohongshu infographic series cover image following these guidelines:
...
**Visual Concept**:
Screen print poster art cover. A football with a golden crown on top (Emperor theme). A speech bubble saying "护球像亨利". Chinese internet meme aesthetic. Bold flat color blocks. Chinese red and gold accents. Halftone textures. Cream background #FAF7F2, deep text #1E293B.
