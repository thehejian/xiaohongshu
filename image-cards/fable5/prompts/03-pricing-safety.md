...
**Visual Concept**:
Screen print infographic card. Split design: left side showing price tag with "$10 / $50" bold numbers, right side showing a shield icon with "95%" in bold. Halftone textures. Bold flat shapes. Cream background #FAF7F2, deep text #1E293B.
