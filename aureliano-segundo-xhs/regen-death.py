...
BASE="/Users/mac/.qclaw/workspace/002-AIagent/03-opencode/003-Twitter/aureliano-segundo-xhs"
api_key=''
...
with open(f"/tmp/seg-{name}.json","w") as f: json.dump(payload,f)
r=subprocess.run(["curl","-s","--max-time","300"]+hdr+["-d",f"@/tmp/seg-{name}.json","https://apihub.agnes-ai.com/v1/images/generations"],capture_output=True,text=True,timeout=300)
